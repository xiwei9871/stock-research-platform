...
from stock_research.citics_research import CiticsResearchClient, login_citics_with_feishu_otp
from stock_research.otp_relay import OtpRelay, serve_otp_relay, start_otp_relay_server
...
from stock_research.watchlist.trend_template_validation import run_trend_discovery_template_validation
from stock_research.watchlist.trend_discovery_v2_replay import run_trend_discovery_v2_replay
from stock_research.watchlist.trend_discovery_v2_purity import run_trend_discovery_v2_purity_audit
from stock_research.watchlist.trend_discovery_v2_2_replay import run_trend_discovery_v2_2_replay
...
from stock_research.watchlist.fundamental_coverage import run_watchlist_fundamental_coverage_audit
from stock_research.watchlist.fundamental_pit_context import run_watchlist_fundamental_pit_context_build
...
from stock_research.mid_trend_adaptive_candidate_review import run_mid_trend_adaptive_candidate_review
from stock_research.mid_trend_adaptive_issue_attribution import run_mid_trend_adaptive_issue_attribution
from stock_research.mid_trend_adaptive_bad_buy_attribution import run_mid_trend_adaptive_bad_buy_attribution
from stock_research.mid_trend_entry_timing_attribution import run_mid_trend_entry_timing_attribution
from stock_research.mid_trend_rebalance_attribution import run_mid_trend_rebalance_attribution
from stock_research.mid_trend_shadow_control_v2_scan import run_mid_trend_shadow_control_v2_scan
from stock_research.mid_trend_bad_rebalance_state_attribution import (
    run_bad_rebalance_state_attribution,
)
from stock_research.diagnostics_candidate_source_audit import run_diagnostics_candidate_source_audit
...
def build_parser() -> argparse.ArgumentParser:
    ...
    otp_relay_server = subparsers.add_parser("otp-relay-server")
    otp_relay_server.add_argument("--host", default="127.0.0.1")
    otp_relay_server.add_argument("--port", type=int, default=8765)

    citics_login = subparsers.add_parser("citics-login-with-feishu-otp")
    citics_login.add_argument("--email", required=True)
    citics_login.add_argument("--feishu-target", required=True)
    citics_login.add_argument("--public-submit-url", required=True)
    citics_login.add_argument("--listen-host", default="127.0.0.1")
    citics_login.add_argument("--listen-port", type=int, default=8765)
    citics_login.add_argument(
        "--token-path",
        default="outputs/research/broker_sessions/citics_token.json",
    )
    citics_login.add_argument("--wait-timeout-seconds", type=int, default=300)
    citics_login.add_argument("--validate")
    citics_login.add_argument("--feishu-account", default="jarvis")
    citics_login.add_argument("--openclaw-bin", default="openclaw")
    citics_login.add_argument("--dry-run", action="store_true")

    citics_reports = subparsers.add_parser("citics-list-reports")
    citics_reports.add_argument("--keyword", required=True)
    citics_reports.add_argument("--start-date", required=True)
    citics_reports.add_argument("--end-date", required=True)
    citics_reports.add_argument(
        "--token-path",
        default="outputs/research/broker_sessions/citics_token.json",
    )
    citics_reports.add_argument("--page", type=int, default=1)
    citics_reports.add_argument("--page-size", type=int, default=50)
    ...
    intraday_risk_control_v2_backtest.add_argument(
        "--risk-preset",
        choices=["v2_1_strict", "v2_2_midband"],
        default="v2_1_strict",
    )
    ...
    backfill_intraday_features = subparsers.add_parser(
    ...
    review_dual_strategy_effectiveness = subparsers.add_parser("review-dual-strategy-effectiveness")
    ...
    validate_trend_discovery_templates = subparsers.add_parser("validate-trend-discovery-templates")
    ...
    audit_trend_discovery_v2_purity = subparsers.add_parser("audit-trend-discovery-v2-purity")
    ...
    review_trend_discovery_v2_2_stability.add_argument("--output-dir", default="outputs/research")

    audit_watchlist_fundamental_coverage = subparsers.add_parser("audit-watchlist-fundamental-coverage")
    ...
    build_watchlist_fundamental_pit_context = subparsers.add_parser("build-watchlist-fundamental-pit-context")
    build_watchlist_fundamental_pit_context.add_argument(
        "--detail-path",
        default="outputs/research/watchlist_diagnostics_effectiveness_detail.csv",
    )
    build_watchlist_fundamental_pit_context.add_argument("--output-dir", default="outputs/research")
    ...
    diagnostics_candidate_source_audit = subparsers.add_parser("audit-diagnostics-candidate-source")
    ...
    stock_report_web_sources.add_argument(
        "--adapter",
        choices=["web_search", "akshare_em", "bing_site_search", "sina_report_page", "sohu_jlp_rating", "cfi_ybyl"],
        default="web_search",
    )
    stock_report_web_sources.add_argument("--write-db", action="store_true")
    stock_report_web_sources.add_argument("--max-results-per-task", type=int, default=3)
    stock_report_web_sources.add_argument("--workers", type=int, default=1)
    stock_report_web_sources.add_argument("--progress-every", type=int, default=50)
    ...
    stock_report_pdf_field_backfill.add_argument("--sample-size", type=int)
    stock_report_pdf_field_backfill.add_argument("--sleep-seconds", type=float, default=0.05)
    ...
    hibor_ui_run.set_defaults(import_pdfs=True, run_pdf_backfill=True, open_legacy_search=True)
    ...
    yanbaoke_run.add_argument("--base-target-per-stock", type=int, default=1)
    yanbaoke_run.add_argument("--depth-target-per-stock", type=int, default=3)
    ...
    mid_trend_shadow_weekly_optimization = subparsers.add_parser("optimize-mid-trend-shadow-weekly")
    ...
    mid_trend_shadow_weekly_control = subparsers.add_parser("review-mid-trend-shadow-weekly-control")
    ...
    mid_trend_adaptive_candidate = subparsers.add_parser("review-mid-trend-adaptive-candidate")
    ...
    mid_trend_adaptive_issue = subparsers.add_parser("review-mid-trend-adaptive-issue-attribution")
    mid_trend_adaptive_issue.add_argument(
        "--monthly-path",
        default="outputs/research/mid_trend_adaptive_candidate_review_v1/mid_trend_adaptive_candidate_monthly_stability.csv",
    )
    mid_trend_adaptive_issue.add_argument(
    ...
    mid_trend_adaptive_bad_buy = subparsers.add_parser("review-mid-trend-adaptive-bad-buy-attribution")
    ...
    mid_trend_entry_timing = subparsers.add_parser("review-mid-trend-entry-timing-attribution")
    ...
    mid_trend_shadow_replacement_scan = subparsers.add_parser("scan-mid-trend-shadow-replacements")
    ...
    mid_trend_drawdown_throttle_scan = subparsers.add_parser("scan-mid-trend-drawdown-throttle")
    ...
    mid_trend_trend_protection_stability = subparsers.add_parser("review-mid-trend-protection-stability")
    ...
    mid_trend_trend_protection_stability.add_argument("--transaction-cost-bps", type=float, default=20.0)
    ...
    mid_trend_rebalance_attribution = subparsers.add_parser("review-mid-trend-rebalance-attribution")
    mid_trend_rebalance_attribution.add_argument(
        "--trades-path",
        default="outputs/research/mid_trend_shadow_weekly_control_v1/mid_trend_shadow_weekly_control_trades.csv",
    )
    mid_trend_rebalance_attribution.add_argument(
        "--equity-path",
        default="outputs/research/mid_trend_shadow_weekly_control_v1/mid_trend_shadow_weekly_control_equity.csv",
    )
    ...
    mid_trend_rebalance_attribution.add_argument("--variant-name", default="top5_weekly_max_2_replacements")
    ...
    bad_rebalance_state_attribution = subparsers.add_parser("review-bad-rebalance-state-attribution")
    bad_rebalance_state_attribution.add_argument(
        "--attribution-detail-path",
        default="outputs/research/mid_trend_rebalance_attribution/mid_trend_rebalance_attribution_detail.csv",
    )
    bad_rebalance_state_attribution.add_argument(
        "--funnel-detail-path",
        default="outputs/research/mid_trend_watch_funnel_detail.csv",
...
def main_for_args(argv: list[str] | None = None) -> None:
    ...
    if args.command == "apply-schema":
    ...
    elif args.command == "otp-relay-server":
        print(f"otp_relay_server|status|listening|host|{args.host}|port|{args.port}", flush=True)
        serve_otp_relay(OtpRelay(), host=args.host, port=args.port)
    elif args.command == "citics-login-with-feishu-otp":
        relay = OtpRelay()
        server = start_otp_relay_server(relay, host=args.listen_host, port=args.listen_port)
        print(
            "citics_login_with_feishu_otp|relay|listening|"
            f"host|{args.listen_host}|port|{server.server_address[1]}",
            flush=True,
        )
        try:
            result = login_citics_with_feishu_otp(
                client=CiticsResearchClient(),
                relay=relay,
                email=args.email,
                feishu_target=args.feishu_target,
                public_submit_url=args.public_submit_url,
            ...
            print("citics_login_with_feishu_otp|status|logged_in")
            print(f"citics_login_with_feishu_otp|login_name|{user.get('loginName', '')}")
            print(f"citics_login_with_feishu_otp|token_path|{args.token_path}")
        finally:
            server.shutdown()
            server.server_close()
    elif args.command == "citics-list-reports":
        client = CiticsResearchClient()
        if not client.load_token(args.token_path):
            raise RuntimeError(f"citics token not found or empty: {args.token_path}")
        ...
        print(f"watchlist_context_cross|fundamental_summary|{result['paths']['fundamental_summary']}")
        ...
        print(f"dual_strategy_review|trend_discovery_summary|{result['paths']['trend_discovery_summary']}")
        ...
        print(f"trend_discovery_v2_purity|high_elasticity_slice|{result['paths']['high_elasticity_slice']}")
        print(
        ...
        print(f"strong_winner_discovery_pool|effectiveness|{result['paths']['pool_effectiveness']}")
        ...
        if args.news_enrichment_path is not None:
            ...
            print(f"mid_trend_position_dossier|news_enrichment_provided|{status.get('news_enrichment_provided', 'yes')}")
            print(f"mid_trend_position_dossier|news_enrichment_used|{status.get('news_enrichment_used', 'no')}")
            print(f"mid_trend_position_dossier|matched_news_rows|{status.get('matched_news_rows', 0)}")
        ...
        print(f"stock_report_backfill_run|status|{result['paths']['status']}")
        ...
        print(f"stock_report_backfill_watchdog|action|{result['status'].watchdog_action}")
        print(f"stock_report_backfill_watchdog|work_remaining|{result['status'].work_remaining}")
        ...
        summary = result["post_summary"]
        print(f"stock_report_pdf_backfill_watchdog|action|{result['status'].watchdog_action}")
        print(f"stock_report_pdf_backfill_watchdog|work_remaining|{result['status'].work_remaining}")
        ...
        result = run_yanbaoke_report_backfill(
            ...
            base_target_per_stock=args.base_target_per_stock,
            depth_target_per_stock=args.depth_target_per_stock,
